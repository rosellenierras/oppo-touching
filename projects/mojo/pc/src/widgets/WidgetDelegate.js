 ...
 *
 */
Ext.define('Vitria.WidgetDelegate', {
    
    alias: 'widget.WidgetDelegate',
    ...
    */
    ...
    constructor: function(cfg) {
        ...
        //me.mixins.observable.constructor.call(this, arguments);
    ...
    render: function(parent) {
        var me = this;
        var factory = Vitria.WidgetLib.self.getWidget(me.widgetType);
        // give a flag to factory for identify the legacy charts
        if(Vitria.WidgetLib.self.isLegacyWidget(me.widgetType)) {
